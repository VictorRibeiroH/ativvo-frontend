...
export function RightSidebar({
  ...
  return (
    <aside
      style={{ backgroundColor: "#6266EB1A" }}
      className="hidden lg:flex w-80 flex-col border-l border-white/10 overflow-y-auto"
    >
      <div className="p-6">
        ...
        {/* Card do Usuário */}
        <Card
          style={{ backgroundColor: "rgba(98, 102, 235, 0.1)" }}
          ...
          <div className="w-full grid grid-cols-2 gap-2">
            <div className="relative month-selector-container">
              <Button
                ...
                style={{
                  backgroundColor: "rgba(238, 64, 95, 0.2)",
                  color: "#EE405F",
                }}
